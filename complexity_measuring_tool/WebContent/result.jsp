...
<body>
		...
		<div class="collapse navbar-collapse" id="navbarCollapse">
			<div class="navbar-nav">
				<a href="Home.jsp" class="nav-item nav-link active">Home</a> <a
					...
					href="History.jsp" class="nav-item nav-link">History</a> <a
					href="#" class="nav-item nav-link">Feedback</a>
			</div>
	...
	<h2 style="color: #ffffff;">Complexity type of a statement value
		is ${ctc}</h2>
	<h2 style="color: #ffffff;">Complexity of inheritance value is
		${tci}</h2>
